%% sensore 1 cluster 3 features 5
close all;
targetIn = [zeros(24,1) ones(24,1);
            ones(12,1) zeros(12,1);
            zeros(12,1) ones(12,1)];


targetTest = [zeros(16,1) ones(16,1);
              ones(8,1) zeros(8,1);
              zeros(8,1) ones(8,1)]; 
...
for k=1:1:12
 ...
 opt = [1.5,50,1e-6,0];
 SugenoFis = genfis3(Xinp,targetIn,'sugeno',3,opt);
 MamdaniFis = genfis3(Xinp,targetIn,'mamdani',3,opt);
