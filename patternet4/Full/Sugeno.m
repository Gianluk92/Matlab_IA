...
target = [ones(10,1) zeros(10,3);
          zeros(10,1) ones(10,1) zeros(10,2);
          zeros(10,2) ones(10,1) zeros(10,1);
          zeros(10,3) ones(10,1)];
...
for cluster=1:1:12
    ...
    for features=1:1:10
        ...
        warning off
        opt = [1.5,50,1e-6,0];
        sugenoFis = genfis3(Xinp,target,'sugeno',cluster,opt);
...
sugenoFis = genfis3(Xinp,target,'sugeno',4,opt);
out = evalfis(Xinp,sugenoFis);
plotconfusion(target',out');

figure

mamdaniFis = genfis3(Xinp,target,'mamdani',4,opt);
