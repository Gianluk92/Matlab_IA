...
for i=1:1:4
    for j=1:1:10
        data_4{i,j*4-3} = data{i,j}(1:500,:);
        data_4{i,j*4-2} = data{i,j}(501:1000,:);
        data_4{i,j*4-1} = data{i,j}(1001:1500,:);
        data_4{i,j*4} = data{i,j}(1501:2000,:);
    end
end
...
for i=1:1:40
    for j=1:1:4
        ...
        m4 = std(data_4{j,i}(:,1:3));
        dev_sta{j} = [dev_sta{j}; m4];
        m5 = var(data_4{j,i}(:,1:3));
        varianz{j} = [varianz{j};m5]; 
        c1 = xcorr(data_4{j,i}(:,1)); 
        c2 = xcorr(data_4{j,i}(:,2));
        c3 = xcorr(data_4{j,i}(:,3));
        c = [c1 c2 c3];
        cm = max(c);  
